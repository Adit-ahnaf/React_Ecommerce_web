    ...
    <div className="App">
      ...
      <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6 bg-green-300" >
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <div>
            <a href="/cart" class="inline-block text-sm px-4 py-2 leading-none border rounded text-green-900 border-green-800 hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Cart</a>
          </div>
        </div>
